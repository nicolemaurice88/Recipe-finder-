...
non-food items and sometimes it picks up the correct items.
...
can be used, anything other than that will not work for the program without
having to update the code.I have provided multiple files to test
the program.
